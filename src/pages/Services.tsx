      ...
      <main>
        <section className="relative h-[42vh] md:h-[52vh] overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-center h-full text-center px-4">
            ...
            >
              <h1 className="font-heading text-5xl md:text-6xl text-white mb-3 tracking-wide font-bold">
                Services
              </h1>
                    ...
                    >
                      <div className="relative aspect-[3/2] w-full">
                        ...
                        <div className="relative z-10 flex flex-col justify-end h-full p-6">
                          <h2 className="font-heading text-2xl text-white mb-1 tracking-wide font-bold">
                            {s.title}
                          </h2>
