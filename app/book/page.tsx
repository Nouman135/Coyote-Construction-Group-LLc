...
export default function BookPage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <section className="section-padding">
          <div className="container-max">
            <div className="overflow-hidden rounded-lg border border-border bg-card shadow-[0_18px_45px_-30px_hsl(var(--accent)/0.65)]">
              <iframe
                src="https://link.adssurveys.com/widget/booking/JKO8uHIt0sLkXD0iDdNy"
                id="JKO8uHIt0sLkXD0iDdNy_1782260846160"
      ...
      <Footer />
      <Script src="https://link.adssurveys.com/js/form_embed.js" strategy="afterInteractive" />
    </div>
  );
}
