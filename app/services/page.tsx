      ...
      <main>
        <section className="relative h-[42vh] md:h-[52vh] overflow-hidden">
          <img
            ...
            alt="Trust Contractors Inc services"
          ...
          <div className="relative z-10 flex items-center justify-center h-full text-center px-4">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 max-w-2xl mx-auto">
                New construction, additions, remodeling, roofing, carpentry, siding, painting, windows, doors, and general
                contracting across Greater Boston.
              </p>
            </motion.div>
          </div>
        </section>
